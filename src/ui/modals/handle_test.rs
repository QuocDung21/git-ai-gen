...
pub fn render_handle_test(f: &mut Frame, app: &App, area: Rect) {
    ...
    let diag_lines = vec![
        Line::from(""),
        Line::from(vec![
            Span::styled(app.locales.dev_folder_label.clone(), Style::default().fg(theme.cyan)),
            Span::styled(app.current_dir.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled(app.locales.dev_lang_label.clone(), Style::default().fg(theme.cyan)),
            Span::styled(app.current_lang.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled(app.locales.dev_theme_label.clone(), Style::default().fg(theme.cyan)),
            Span::styled(app.theme_id.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled(app.locales.dev_light_label.clone(), Style::default().fg(theme.cyan)),
            Span::styled(app.is_light_theme.to_string(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled(app.locales.dev_changes_label.clone(), Style::default().fg(theme.cyan)),
            Span::styled(app.files.len().to_string(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled(app.locales.dev_scanned_label.clone(), Style::default().fg(theme.cyan)),
            Span::styled(format!("{} entries", app.language_stats.len()), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled(app.locales.dev_ide_label.clone(), Style::default().fg(theme.cyan)),
            Span::styled(app.editor.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled(app.locales.dev_conflict_label.clone(), Style::default().fg(theme.cyan)),
            Span::styled(
    ...
    let play_lines = vec![
        ...
        Line::from(vec![
            ...
            Span::styled(app.locales.dev_action_theme.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled("   ⚡ [2] : ", Style::default().fg(theme.border)),
            Span::styled(app.locales.dev_action_alert.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled("   ⚡ [3] : ", Style::default().fg(theme.border)),
            Span::styled(app.locales.dev_action_reset_stats.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled("   ⚡ [4] : ", Style::default().fg(theme.border)),
            Span::styled(app.locales.dev_action_diff.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled("   ⚡ [5] : ", Style::default().fg(theme.border)),
            Span::styled(app.locales.dev_action_ffi.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled("   ⚡ [6] : ", Style::default().fg(theme.border)),
            Span::styled(app.locales.dev_action_conflict.clone(), Style::default().fg(theme.fg)),
        ]),
        Line::from(vec![
            Span::styled("   ⚡ [7] : ", Style::default().fg(theme.border)),
            Span::styled(app.locales.dev_action_lang.clone(), Style::default().fg(theme.fg)),
        ]),
    ];
