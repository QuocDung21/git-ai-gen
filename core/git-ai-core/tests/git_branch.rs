...
use git_ai_core_shared::git::branch::{self, DeleteBranchOptions};
...
fn test_force_delete_vs_normal_delete() {
    ...
    let options_normal = git_ai_core_shared::git::branch::DeleteBranchOptions {
        local: true,
        remote: false,
        force: false,
    };
    let res_normal =
        git_ai_core_shared::git::branch::delete_branch("unmerged-branch", options_normal);
    ...
    let options_force = git_ai_core_shared::git::branch::DeleteBranchOptions {
        local: true,
        remote: false,
        force: true,
    };
    let res_force =
        git_ai_core_shared::git::branch::delete_branch("unmerged-branch", options_force);
...
fn test_merge_conflict_scenario() {
    ...
    Command::new("git")
        ...
        .output()
        .unwrap();
    let res = git_ai_core_shared::git::branch::git_merge("branch-b");
...
fn test_remote_auto_detection() {
    let _guard = GIT_TEST_LOCK.lock().unwrap_or_else(|p| p.into_inner());
    let _tmp = setup_test_repo();
    let options = git_ai_core_shared::git::branch::DeleteBranchOptions {
        local: true,
        remote: false,
        force: false,
    };
    ...
    let res = git_ai_core_shared::git::branch::delete_branch("origin/feature-x", options);
...
fn test_delete_non_existent_branch() {
    ...
    let res = git_ai_core_shared::git::branch::delete_branch("ghost-branch", options);
