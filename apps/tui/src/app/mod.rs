...
impl App {
    ...
    pub fn new() -> Self {
        ...
        let auto_push = config::load_bool_config("git-ai.auto-push", true);
        let auto_stage_all = config::load_bool_config("git-ai.auto-stage-all", false);
        let kilo_ai_enabled = config::load_bool_config("git-ai.kilo-ai", true);
        let splash_enabled = config::load_bool_config("git-ai.splash", true);
        let editor = config::load_editor();
        let selected_editor_index = config::selected_editor_index(&editor);
